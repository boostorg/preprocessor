...
# define BOOST_PP_SLOT_OFFSET_9(x) (x) % 100000000UL
# define BOOST_PP_SLOT_OFFSET_8(x) (x) % 10000000UL
# define BOOST_PP_SLOT_OFFSET_7(x) (x) % 1000000UL
# define BOOST_PP_SLOT_OFFSET_6(x) (x) % 100000UL
# define BOOST_PP_SLOT_OFFSET_5(x) (x) % 10000UL
# define BOOST_PP_SLOT_OFFSET_4(x) (x) % 1000UL
# define BOOST_PP_SLOT_OFFSET_3(x) (x) % 100UL
# define BOOST_PP_SLOT_OFFSET_2(x) (x) % 10UL
#
# /* BOOST_PP_SLOT_CC_x */
#
